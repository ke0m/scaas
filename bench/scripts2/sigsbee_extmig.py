...
img = wei.image_data(dat,dt,ntx=16,minf=1,maxf=51,vel=velint,nrmax=20,nhx=20,nthrds=40)
imgt = np.transpose(img,(2,4,3,1,0))  # [nhy,nhx,nz,ny,nx] -> [nz,nx,ny,nhx,nhy]

nhx,ohx,dhx = wei.get_off_axis()

sep.write_file("mysigimgext.H",imgt,os=[oz,oxi,0,ohx,0],ds=[dz,dxi,dy,dhx,1.0])
