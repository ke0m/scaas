"""
Migrated image for multiple shots
...
imgp  = np.zeros(dvelp.shape,dtype='float32')
sca.brnadj(allsrcs,allsrcx,allsrcz,nsrc,allrecx,allrecz,nrec,nsx,velp,imgp,ddat,nthreads)
