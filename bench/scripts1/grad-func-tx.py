...
miscArgs.add_argument("-iztt",help="Top top depth sample for taper [0]",type=int)
miscArgs.add_argument("-izbt",help="Bottom top depth sample for taper [0] (default no taper)",type=int)
miscArgs.add_argument("-iztb",help="Bottom top depth sample for taper [0]",type=int)
miscArgs.add_argument("-izbb",help="Bottom bottom depth sample for taper [0] (default no taper)",type=int)
# Quality check
...
# Gradient taper
iztt = args.iztt; izbt = args.izbt
iztb = args.iztb; izbb = args.izbb
...
tpdict = {}; tpdict['iztt'] = iztt; tpdict['izbt'] = izbt;
tpdict['iztb'] = iztb; tpdict['izbb'] = izbb;
