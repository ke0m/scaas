...
# Outputs
sep = seppy.sep()
sep.write_file("sigsbee_shotflat2.H",muted.T,ds=[dt,1.0])
sep.write_file("sigsbee_recxflat2.H",recxs)
sep.write_file("sigsbee_srcxflat2.H",srcx)
sep.write_file("sigsbee_nrec2.H",nrecs)
