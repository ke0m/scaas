...
daxes,dat = sep.read_file("mydat_fftw.H")
...
img = wei.image_data(datin,dt,minf=1.0,maxf=31.0,vel=velin,nhx=16,ntx=15,
...
sep.write_file("myimgext_fftw.H",imgt,os=[0,0,0,ohx,0],ds=[dz,dy,dx,dhx,1.0])

#sep.write_file("myimg_fftw.H",img,ds=[dz,dy,dx])
